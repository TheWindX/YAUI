...
namespace ns_pixelPicker
{
    ...
    class Program
    {
        ...
        static bool GetKeyPressState(int vk)
        {
        ...
        static void test1()
        {
            ...
            ns_YAUtils.TimerManager.get().setInterval(
                (i, t) =>
                {
                    if (GetKeyPressState((int)VirtualKeyStates.VK_LSHIFT) && GetKeyPressState((int)VirtualKeyStates.VK_E))
                    {
                        SetVolUP();
                        Console.WriteLine("up");
                    }

                    else if (GetKeyPressState((int)VirtualKeyStates.VK_LSHIFT) && GetKeyPressState((int)VirtualKeyStates.VK_D))
                    {
                        SetVolDown();
                        Console.WriteLine("down");
                    }

                    else if (GetKeyPressState((int)VirtualKeyStates.VK_LSHIFT) && GetKeyPressState((int)VirtualKeyStates.VK_S))
                    {
                        SetVolMute();
